...
from .models.tender_models import TenderData, ScrapingJob, ScrapingStatus
...
async def get_suggested_keywords():
    ...
    return {
        "categories": {
            "windows": ["windows", "replacement windows", "aluminum windows", "vinyl windows"],
            "doors": ["doors", "entrance doors", "patio doors", "sliding doors"],
            "glazing": ["glazing", "curtain wall", "storefront", "commercial glazing"],
            "installation": ["installation", "window installation", "door installation"],
            "materials": ["fenestration", "glass", "frames", "hardware"]
        },
        "suggested": [
            "windows", "doors", "fenestration", "glazing", "curtain wall",
            "storefront", "aluminum windows", "vinyl windows", "installation",
            "replacement windows", "commercial glazing", "residential windows"
        ]
    }
